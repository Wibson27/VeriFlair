...
import { idlFactory } from './veriflair_backend.did.js';
export { idlFactory } from './veriflair_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_VERIFLAIR_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./veriflair_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the veriflair_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./veriflair_backend.did.js")._SERVICE>}
 */
export const veriflair_backend = createActor(canisterId);
