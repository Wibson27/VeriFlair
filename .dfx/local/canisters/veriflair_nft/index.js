...
import { idlFactory } from './veriflair_nft.did.js';
export { idlFactory } from './veriflair_nft.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_VERIFLAIR_NFT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./veriflair_nft.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the veriflair_nft canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./veriflair_nft.did.js")._SERVICE>}
 */
export const veriflair_nft = createActor(canisterId);
