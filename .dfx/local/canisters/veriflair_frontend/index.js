...
import { idlFactory } from './veriflair_frontend.did.js';
export { idlFactory } from './veriflair_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_VERIFLAIR_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./veriflair_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the veriflair_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./veriflair_frontend.did.js")._SERVICE>}
 */
export const veriflair_frontend = createActor(canisterId);
